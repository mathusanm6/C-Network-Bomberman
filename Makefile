...
SRCFILESCLIENT := $(shell find $(SRCDIR) -type f -name "*.c" ! -name "server.c" ! -name "network_server.c")
SRCFILESSERVER := $(shell find $(SRCDIR) -type f -name "*.c" ! -name "client.c" ! -name "network_client.c")
